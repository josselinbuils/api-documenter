...
test('render Markdown from TSDoc', () => {
  ...
  output.appendNodes([
    new DocHeading({ title: 'Simple bold test' }),
  ...
  output.appendNodes([
    new DocHeading({ title: 'All whitespace bold' }),
    new DocParagraph({ configuration }, [
      new DocEmphasisSpan({ configuration, bold: true }, [
  ...
  output.appendNodes([
    new DocHeading({ title: 'Newline bold' }),
    new DocParagraph({ configuration }, [
      new DocEmphasisSpan({ configuration, bold: true }, [
  ...
  output.appendNodes([
    new DocHeading({ title: 'Newline bold with spaces' }),
    new DocParagraph({ configuration }, [
      new DocEmphasisSpan({ configuration, bold: true }, [
        new DocPlainText({ configuration, text: '  line 1  ' }),
        new DocSoftBreak({ configuration }),
  ...
  output.appendNodes([
    new DocHeading({ title: 'Adjacent bold regions' }),
    new DocParagraph({ configuration }, [
      new DocEmphasisSpan({ configuration, bold: true }, [
  ...
  output.appendNodes([
    new DocHeading({ title: 'Adjacent to other characters' }),
    new DocParagraph({ configuration }, [
      new DocLinkTag({
        configuration,
        tagName: '@link',
  ...
  output.appendNodes([
    new DocHeading({ title: 'Bad characters' }),
    new DocParagraph({ configuration }, [
      new DocEmphasisSpan({ configuration, bold: true }, [
